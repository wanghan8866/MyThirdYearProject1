...
from frame.multiFrame import MultiPlayerFrame
...
class AppWindow(ctk.CTk):
    def __init__(self):
        ...
        self.multi_button = ctk.CTkButton(self.navigation_frame, corner_radius=0, height=40,
                                          border_spacing=10, text="Multi-Player Mode", fg_color="transparent",
                                          text_color=("gray10", "gray90"), hover_color=("gray70", "gray30"),
                                          image=ImageLoader.getTkImage("chat"), anchor="w",
                                          command=lambda: self.select_frame_by_name("multi"))
        ...
        self.setting_button.grid(row=4, column=0, sticky="ew")
        ...
        self.multi_frame = MultiPlayerFrame(self, corner_radius=0, fg_color="transparent")
    ...
    def select_frame_by_name(self, name):
        ...
        self.multi_button.configure(fg_color=("gray75", "gray25") if name == "multi" else "transparent")
        ...
        if name == "multi":
            self.multi_frame.grid(row=0, column=1, sticky="nsew")
        else:
            self.multi_frame.grid_forget()
        if name == "setting":
